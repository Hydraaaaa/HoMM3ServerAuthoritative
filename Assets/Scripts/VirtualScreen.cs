// Copied from https://forum.unity.com/threads/interaction-with-objects-displayed-on-render-texture.517175/
...
public class VirtualScreen : GraphicRaycaster
{
    ...
    public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
    {
        ...
        {
            RaycastBeyondRenderTexture(hit, resultAppendList);
        }
    }

    private void RaycastBeyondRenderTexture(RaycastHit originHit, List<RaycastResult> resultAppendList)
    {
